...
public class PlayInfoDto {
	...
	public PlayInfoDto(Integer play_id, String movieTitle, String Runtime, String Rating, String Poster,
			String Kind, String Section, Integer Seat, String MovieDate, String Start, String End, ArrayList<String> arrayList) {
		this.play_info_id = play_id;
