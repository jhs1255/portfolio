...
public class PointUsingPopupController {
    ...
    public void initialize() {
    	System.out.println("Initialize 호출됨"); // 이 로그가 출력되는지 확인
        // 처음에 확인 버튼 비활성화
        ...
        confirmButton.setOnAction(e->{
        	...
        	requestDto.setRequestCode(RequestCode.GET_PHONENUMBER_STRING);
        	...
        	ObjectMapper objectMapper = new ObjectMapper();
        	 try {
                 ...
                 if (statusCode == StatusCode.SUCCESS.getStatusCode()) {
                     ...
                     MemberDto memberDto = objectMapper.convertValue(jsonMap.get("body"), new TypeReference<MemberDto>() {});
                     memberDto.setPhoneNumber(phoneNumber);
                     
                     FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/2-2.PointUsingSuccessPopup.fxml"));
                     System.out.println("Before loading next page...");
                     Parent nextPage = loader.load();
                     System.out.println("Next page loaded.");
                     
                     PointUsingSuccessPopupController pointController = loader.getController();
                     ...
                     pointController.setPhoneNumber(phoneNumber);
                	...
                	// 유효하지 않은 경우, NoReservation 팝업을 띄움
                     FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/0-2.WrongInputPopup.fxml"));
