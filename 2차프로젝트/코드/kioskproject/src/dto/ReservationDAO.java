...
//		String sql = "INSERT INTO reservation_info (play_info_id, seats, people, resNumber, totalprice) "
//				+ "VALUES (?,?,?,?,?)";
//		try(Connection con = DBConnection.getConnection();
//				PreparedStatement pstmt = con.prepareStatement(sql)){
//				pstmt.setInt(1, movieData.getSelectedPlay_info_id());
//				pstmt.setString(2, seats);
//				pstmt.setString(3, String.join(", " , peopleDetails));
//				pstmt.setString(4, reservationNumber);
//				pstmt.setInt(5, totalPrice);
////				pstmt.setInt(6, usePoint);
////				pstmt.setInt(7, savePoint);
    ...
    public ReservationDTO getReservationByNumber(String reservationNumber) {
    	...
    	try (Connection con = DBConnection.getConnection();
            ...
            if(rs.next()) {
            	...
            	reservation.setMovieDate(rs.getDate("movie_date").toLocalDate().toString());
            	reservation.setMovieStart(rs.getTime("movie_start").toLocalTime().toString());
            	reservation.setMovieEnd(rs.getTime("movie_end").toLocalTime().toString());
