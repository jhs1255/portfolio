...
public class ReservationPrintPopupController {
    ...
    private void handleYesButtonAction(ActionEvent event) {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/exam/app/view/3-2.ReservationPrintYesPopup.fxml"));
    ...
    private void handleNoButtonAction(ActionEvent event) {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/exam/app/view/3-3.ReservationPrintNoPopup.fxml"));
            Parent root = fxmlLoader.load();
            Stage stage = (Stage) ((javafx.scene.Node) event.getSource()).getScene().getWindow();
            stage.setScene(new Scene(root));
            stage.show();
